...
export const UP_MEMBERS_CONFIG: UpMember[] = [
    {
        ...
        background: '/up-members/amazong.png',
        title: '名利大王',
        honor: '占位',
    ...
    },
    {
        ...
        background: '/up-members/liyuanjun.png',
        title: '暗影混子',
        honor: '占位',
    ...
    },
    {
        ...
        background: '/up-members/xudaxia.png',
        title: '电竞后羿',
        honor: '占位',
        buffs: ['准度提升80%'],
        debuffs: ['体力下降100%'],
    ...
    },
    {
        ...
        background: '/up-members/yuge.png',
        title: '实力雨神',
        honor: '占位',
        buffs: ['初始所有属性提升30%'],
    ...
    },
    {
        ...
        background: '/up-members/zhebie.png',
        title: '猖狂人才',
        honor: '占位',
    ...
    },
    {
        ...
        background: '/up-members/sanmu.png',
        title: '招魂仙人',
        honor: '占位',
        buffs: ['幸运值提升40%'],
        debuffs: ['其余所有属性下降40%'],
