...
export const UP_MEMBERS_CONFIG: UpMember[] = [
    {
        ...
        background: '/up-members/amazong_minecraft.png',
        pageBackground: '/up-members/amazong_bg_minecraft.png',
        title: '名利大王',
        honor: '占位',
        ...
        stats: { 力量: 1.5, 默契: 2, 技巧: 1, 智力: 5, 运气: 1, 准度: 1.5, 感官: 8 },
    ...
    },
    {
        ...
        background: '/up-members/liyuanjun_minecraft.png',
        pageBackground: '/up-members/liyuanjun_bg_minecraft.png',
        title: '暗影混子',
        honor: '占位',
    ...
    },
    {
        ...
        background: '/up-members/xudaxia_minecraft.png',
        pageBackground: '/up-members/xudaxia_bg_minecraft.png',
        title: '电竞后羿',
        honor: '占位',
        buffs: ['准度提升80%'],
        debuffs: ['体力下降100%'],
    ...
    },
    {
        ...
        background: '/up-members/yuge_minecraft.png',
        pageBackground: '/up-members/yuge_bg_minecraft.png',
        title: '实力雨神',
        honor: '占位',
        buffs: ['初始所有属性提升30%'],
    ...
    },
    {
        ...
        background: '/up-members/zhebie_minecraft.png',
        pageBackground: '/up-members/zhebie_bg_minecraft.png',
        title: '猖狂人才',
        honor: '占位',
    ...
    },
    {
        ...
        background: '/up-members/sanmu_minecraft.png',
        pageBackground: '/up-members/sanmu_bg_minecraft.png',
        title: '招魂仙人',
        honor: '占位',
        buffs: ['幸运值提升40%'],
        debuffs: ['其余所有属性下降40%'],
