      ...
      <div className="flex-1 relative flex flex-col gap-4 md:gap-6 mt-2">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-2 shrink-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
            <a 
              href="mailto:XYGSS888@163.com"
              className="flex items-center justify-center gap-2 px-4 py-2.5 md:py-2 text-[13px] md:text-sm tracking-widest border border-[#88B090] text-[#88B090] hover:bg-[#88B090] hover:text-white transition-all duration-300 shrink-0 bg-white bg-opacity-60 backdrop-blur-sm w-full md:w-auto"
              title="发送邮件至 XYGSS888@163.com 投稿游戏"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="square" strokeLinejoin="miter" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
              投稿游戏
            </a>
            ...
            {activeGame ? (
              <>
                ...
                <div className="w-full md:w-[240px] lg:w-[320px] shrink-0 bg-[#FAFAFA] p-4 border border-[#F0F0F0] h-full overflow-y-auto custom-scrollbar">
                  <h4 className="text-[10px] md:text-xs text-[#999999] tracking-[0.2em] mb-2 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-1.5">
                      <span className="w-1 h-1 bg-[#88B090] inline-block"></span>
                      关卡结果
                    </div>
                    <span className="text-[9px] md:text-[10px] text-[#CCCCCC] tracking-widest font-light">
                      *按首位过关者(含放弃)统计
                    </span>
                  </h4>
